...
// 	useEffect(() => {
// 		// show navbar after splash animation is done
// 		const timer = setTimeout(() => {
// 			setShowNav(true);
// 		}, 1500); // match your logo fade duration
...
// 				>
// 					<Image src={logo} w={"800px"} objectFit="contain" />
// 				</motion.div>
...
// 				>
// 					{" "}
// 					<Text fontSize="4xl"> Studying Eukaryotic Innate Immunity </Text>{" "}
// 				</motion.div>{" "}
// 				<motion.div
// 					initial={{ opacity: 0, y: 0 }}
// 					animate={{ opacity: 1, y: 0 }}
    ...
    <Box minHeight="100vh" overflow="hidden">
      ...
      >
        ...
        <motion.div
          ...
          style={{ position: "absolute" }}
        >
          <Image src={logo} w={["200px", "400px", "800px"]} objectFit="contain" />
        </motion.div>
      ...
      <FadeInSection>
        ...
        >
          ...
          <Text fontSize="2xl" maxW="120ch" px={6}>
            Viruses infect a wide range of organisms, from protists, algae, and fungi to plants
            and animals, relying on host cellular machinery for replication and spread. As hosts
            evolve defense pathways to restrict infection, viruses concurrently develop
            countermeasures that suppress or evade these defenses. This ongoing co-evolution
            drives a continual host–virus arms race. Our lab investigates the identification,
            regulation, evolution, and antagonism of antiviral systems across diverse eukaryotic
            lineages.
          </Text>
        </Flex>
      </FadeInSection>
      ...
      <FadeInSection>
        ...
        >
          ...
          <Flex mt={10} wrap="wrap" gap={6} justify="center" maxW="1200px" px={4}>
            {researchProjects.map((project) => (
              <motion.div
                key={project.title}
                whileHover={{ scale: 1.05 }}
